...
<head>
    ...
    <style>
        ...
        .soft-ui-red {
            ...
            color: white;
            box-shadow: 6px 6px 12px #d65959, -6px -6px 12px #ff7b7b;
        }
        ...
        <form action="<?=site_url('update/'.$user['student_id']);?>" method="POST" class="space-y-6">
            ...
            <div class="flex gap-4">
                <input type="submit" value="SUBMIT"
                    class="flex-1 text-center soft-ui soft-ui-red soft-ui-hover soft-ui-active text-white font-bold py-3 text-lg cursor-pointer transition-colors duration-150" />

                <a href="<?=site_url('/view');?>"
                   class="flex-1 text-center font-semibold text-lg px-6 py-3 rounded-xl soft-ui soft-ui-hover soft-ui-active text-gray-700">
                    BACK
                </a>
            </div>
