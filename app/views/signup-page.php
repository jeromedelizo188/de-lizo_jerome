...
<body>
    <div class="container mx-auto max-w-sm">
        <div class="soft-ui p-8 rounded-2xl flex flex-col items-center">
            ...
            <form action="<?= site_url('signup'); ?>" method="POST" class="w-full">
                <div class="mb-6">
                    <label for="first-name" class="block text-gray-500 text-sm font-semibold mb-2">First Name</label>
                    <div class="soft-ui-inset rounded-xl p-2">
                        <input type="text" id="first-name" name="first-name" placeholder="John" class="w-full bg-transparent outline-none text-gray-700 placeholder-gray-400 px-2 py-1">
                    </div>
                </div>
                <div class="mb-6">
                    <label for="last-name" class="block text-gray-500 text-sm font-semibold mb-2">Last Name</label>
                    <div class="soft-ui-inset rounded-xl p-2">
                        <input type="text" id="last-name" name="last-name" placeholder="Doe" class="w-full bg-transparent outline-none text-gray-700 placeholder-gray-400 px-2 py-1">
                    </div>
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="user-type" class="block text-gray-500 text-sm font-semibold mb-2">User Type</label>
                    <div class="soft-ui-inset rounded-xl p-2">
                        <select id="user-type" name="user-type" class="w-full bg-transparent outline-none text-gray-700 px-2 py-1">
            ...
            <div class="mt-6 flex flex-col items-center space-y-2">
                <p class="text-gray-500 text-sm">
                    ...
                    <a href="<?= site_url('login'); ?>" class="font-semibold soft-ui-link">Log In</a>
                </p>
            </div>
        </div>
    </div>
